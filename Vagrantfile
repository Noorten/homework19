MACHINES = {
  ...
  :centralRouter => {
        ...
        :net => [
                   ...
                   ["192.168.50.2", 8, "255.255.255.0",  "ansible"],
                ]
  },
  ...
  :office1Router => {
        ...
        :net => [
                   ...
                   ["192.168.50.4", 7, "255.255.255.0",  "ansible"],
                ]
  },
  ...
  :office1Server => {
        ...
        :net => [
                   ...
                   ["192.168.50.5", 3, "255.255.255.0",  "ansible"],
                ]
  },
  ...
  :office2Router => {
       ...
       :net => [
                   ...
                   ["192.168.50.6", 6, "255.255.255.0",  "ansible"],
               ]
  },
  ...
  :office2Server => {
       ...
       :net => [
                  ...
                  ["192.168.50.7", 3, "255.255.255.0",  "ansible"],
               ]
  }
}
